...
# kitap_4 = Kitap(ad="Tales of demons and gods", yazar ="Mad Snail")
...
# session.commit()
# print(f"Kitap eklendi. Id ={kitap_4.id}" )
...
#     kitap_guncellenecek.ad = "Python Bootcamp Dersleri"
...
kitap_silinecek = session.query(Kitap).filter(Kitap.yazar == 'Can').first()
